    ...
    internal sealed class StudioChangelogForm : Form
    {
        ...
        internal static string HistoryText()
        {
            return CurrentHeading() + "\n\n" + L.T(
                ...
                + "• Custom Pack Maker: RR-Ordner erkennen oder auswählen; RR-Dateien und Sprachzuordnungen übernehmen. ISO ergänzt nur fehlende Earth.szs, BackModel.szs und globe.arc. Bearbeitungs-Tools öffnen Dateien direkt, mit klaren Einstiegshinweisen und einheitlichen Bedienelementen.\n\n"
                ...
                + "• Custom Pack Maker: detect or select the RR folder and copy RR files with language mappings. ISO adds only missing Earth.szs, BackModel.szs and globe.arc. Editing tools open files directly, with clear entry hints and consistent controls.\n\n"
