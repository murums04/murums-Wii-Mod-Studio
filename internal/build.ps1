...
$compilerArgs = @('/nologo','/codepage:65001', '/target:winexe', '/platform:anycpu', '/optimize+', '/main:murumsWiiModStudio.Program', '/reference:System.dll', '/reference:System.Core.dll','/reference:System.Web.Extensions.dll', '/reference:System.Drawing.dll', '/reference:System.Windows.Forms.dll', "/out:$OutputPath", "/win32icon:$PSScriptRoot/source/App/murums.ico", "/win32manifest:$PSScriptRoot/source/App/app.manifest")
foreach ($name in @('SkyStill.brres.gz','SkyAnimated.brres.gz')) {
